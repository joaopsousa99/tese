...
class targetDetector:
    def __init__(self):
        ...
        self.targetCentrePub = rospy.Publisher("target_otsu/centre", Point, queue_size=1)
        self.ellipseDebugger = rospy.Publisher("target_otsu/ellipse_debugging", Image, queue_size=1)
        self.ringDebugger = rospy.Publisher("target_otsu/ring_debugging", Image, queue_size=1)
        self.targetDebugger = rospy.Publisher("target_otsu/target_debugging", Image, queue_size=1)
...
def main():
    ...
    rospy.init_node("target_otsu", anonymous=True)
    rate = rospy.Rate(30)
    td = targetDetector()
